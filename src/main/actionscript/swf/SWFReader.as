/**
 * 
 * Based (heavily) on com.senocular.SWFReader
 * http://senocular.com/flash/actionscript/?file=ActionScript_3.0/com/senocular/utils/SWFReader.as
 * 
 * All ActionScript files (on senocular.com) are provided as is without warranty, 
 * but are completely free to use any way you wish (MIT License).
 * 
 */
