...
package org.libspark.swfassist.swf.filters
{
	...
	public class GradientGlowFilter extends AbstractFilter
	{
		public function GradientGlowFilter(filterId:uint = 0)
		{
			super(filterId != 0 ? filterId : FilterConstants.ID_GRADIENT_GLOW);
		}
		...
		public function fromNativeFilter(filter:flash.filters.GradientGlowFilter):void
		{
		...
		public function toNativeFilter():flash.filters.GradientGlowFilter
		{
			var filter:flash.filters.GradientGlowFilter = new flash.filters.GradientGlowFilter();
