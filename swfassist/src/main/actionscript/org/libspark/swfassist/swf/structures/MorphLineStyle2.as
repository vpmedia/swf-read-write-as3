...
package org.libspark.swfassist.swf.structures
{
	public class MorphLineStyle2 extends MorphLineStyle
	{
		...
		private var _fillType:MorphFillStyle = new MorphFillStyle();
		...
		public function get miterLimitFactor():Number
		{
			return _miterLimitFactor;
		}
		
		public function set miterLimitFactor(value:Number):void
		{
			_miterLimitFactor = value;
		}
		
		public function get fillType():MorphFillStyle
		{
			return _fillType;
		}
		
		public function set fillType(value:MorphFillStyle):void
		{
			_fillType = value;
		}
	}
